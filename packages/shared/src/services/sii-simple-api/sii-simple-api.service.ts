...
export class SiiSimpleApiService extends ProxyService {
  ...
  override makeRequest(values: { method: string; path: string; payload?: any; headers?: any; }, logger: ExecutionLogger, options?: RequestOptions): Promise<any> {
    return super.makeRequest(values, logger, {
      ...options,
      maskOptions: {
        ...options?.maskOptions,
        ...MASK_OPTIONS
